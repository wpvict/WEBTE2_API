  ...
  <div class="row">
    ...
    <form class="col-md-3 alert-success" action="" method="post">
      ...
      <div class="row justify-content-md-center">
        ...
        <input class="btn-info col-md-4 m-1" type="button" name="submit_get_coords" value="Move plane" onclick='get_result(this); return false;'>
...
<script>
  ...
  function draw_plane(ctx, plane_angle, wing_angle){
    ...
    pos['x_tail_back'] = pos['x_center_top'] - (plane_length / 2) * Math.cos(plane_angle);
    pos['y_tail_back'] = pos['y_center_top'] + (plane_length / 2) * Math.sin(plane_angle);

    pos['x_tail_front'] = pos['x_center_top'] - ((plane_length - tail_width) / 2) * Math.cos(plane_angle);
    pos['y_tail_front'] = pos['y_center_top'] + ((plane_length - tail_width) / 2) * Math.sin(plane_angle);
    ...
    pos['x_center_elevator'] = pos['x_center'] - ((plane_length - tail_width) / 2) * Math.cos(plane_angle);
    pos['y_center_elevator'] = pos['y_center'] + ((plane_length - tail_width) / 2) * Math.sin(plane_angle);
