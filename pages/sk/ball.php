  ...
  <div class="row">
    ...
    <form class="col-md-3 board" action="#" method="post">
      ...
      <div class="row justify-content-md-center">
        ...
        <p class="col-md-12">Pre najlepší zážitok použite hodnoty od -800 do +800.</p>
        ...
        <input class="btn-info col-md-4 ml-1" type="button" name="submit_get_coords" value="Pohybujte loptu" onclick='get_result(this); return false;'>
        ...
        <input class="btn-danger col-md-6 m-1" type="button" name="submit_stop_translation" value="Zastavit'vysielanie" onclick='window.location = "/cas?p=ball"'>
