  ...
  <div class="row">
    ...
    <form class="col-md-3 board" action="#" method="post">
      ...
      <div class="row justify-content-md-center">
        ...
        <p class="col-md-12">Pre najlepší zážitok použite hodnoty od -0,5 do +0,5.</p>
        ...
        <input class="btn-info col-md-4 ml-1" type="button" name="submit_get_coords" value="Pohybujte lietadlom" onclick='get_result(this); return false;'>
